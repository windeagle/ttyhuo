 ...
 */
public class UserProductFragment extends BaseListFragment {
    ...
    public UserProductFragment(int userID)
    {
        this.userID = userID;
    }
    ...
    {
        return new String(UrlList.MAIN + "mvc/product_getByUserJson_" + userID);
    }
