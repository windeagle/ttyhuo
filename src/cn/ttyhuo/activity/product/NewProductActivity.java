 ...
 */
public class NewProductActivity extends BaseAddPicActivity {
...
//    int width,height;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_single_truck_fabu = (TextView) findViewById(R.id.tv_single_truck_fabu);
        tv_single_truck_fabu.setOnClickListener(this);
...
//        });
    ...
    private void setupCitySpinner(final TextView cityText, final TextView addrText, LinearLayout city_spinner_ly) {
        ...
        ArrayAdapter<String> cityAdapter = new ArrayAdapter<String>(
                NewProductActivity.this, android.R.layout.simple_spinner_item, AddressData.CITIES[pIndex]);
        // 设置二级下拉列表的选项内容适配器
        ...
        ArrayAdapter<String> countyAdapter = new ArrayAdapter<String>(NewProductActivity.this,
    ...
    private void updateCities(Spinner city, Spinner ccity, int index) {
        ...
        ArrayAdapter<String> cityAdapter = new ArrayAdapter<String>(
                NewProductActivity.this, android.R.layout.simple_spinner_item, AddressData.CITIES[index]);
        // 设置二级下拉列表的选项内容适配器
        city.setAdapter(cityAdapter);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.edit_toAddr:
                ...
                NewProductActivity.this.startActivityForResult(intent, 1);
                break;
            case R.id.iv_action_done:
                ...
                else
                {
                    ...
                    {
                        new MyTask().execute(NewProductActivity.this);
                    }
                }
                break;
            case R.id.tv_single_truck_fabu:
    ...
    private class MyTask extends AsyncTask<Context, Integer, String> {
        ...
        protected void onPreExecute() {
            ...
            dialog = ProgressDialog.show(NewProductActivity.this,
                    NewProductActivity.this.getString(R.string.app_name),
                    NewProductActivity.this.getText(R.string.operating), true, false, null);
            super.onPreExecute();
        }
            ...
            if(result != null){
                try {
                    ...
                    if("not_login".equals(viewName))
                    {
                        ...
                        SetLoginFlag(NewProductActivity.this, false);
                        Intent intent = new Intent(mContext, MainPage.class);
                        Toast.makeText(NewProductActivity.this, "尚未登录！", Toast.LENGTH_SHORT).show();
