 ...
 */
public class MyProductFragment extends BaseListFragment {
    ...
    {
        return new String(UrlList.MAIN + "mvc/product_mylistJson");
    }
    ...
    protected void processJSON(String result)
    {
        try {
            ...
            if (mJson == null) {
                mData = mDataDelta;
                mJson = new ProductListJSONArrayAdapter(mData, getActivity(), true);
    ...
    protected void processItemClick(JSONObject jsonObject)
    {
        ...
        Intent intent = new Intent(mContext, MyProductInfoActivity.class);
        try{
