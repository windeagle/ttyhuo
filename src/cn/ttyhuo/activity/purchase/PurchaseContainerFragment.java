 ...
 */
public class PurchaseContainerFragment extends Fragment {
    ...
    public PurchaseContainerFragment() {
        this(0);
    }

    public PurchaseContainerFragment(int pageIndex) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View v = inflater.inflate(R.layout.fragment_purchase_container, null);
        ...
        tv_page0.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                PurchaseContainerFragment.this.pageIndex = 0;
                lv_page0.setBackgroundResource(R.color.activity_footer_bg);
                lv_page1.setBackgroundResource(R.color.activity_header_bg);
                lv_page2.setBackgroundResource(R.color.activity_header_bg);
                Fragment tmpContent = new PurchaseListViewFragment(PurchaseContainerFragment.this.pageIndex);
                PurchaseContainerFragment.this.getActivity().getSupportFragmentManager().beginTransaction().replace(R.id.tabcontent, tmpContent).commit();
            }
        });
        tv_page1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                PurchaseContainerFragment.this.pageIndex = 1;
        ...
        tv_page2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                PurchaseContainerFragment.this.pageIndex = 2;
                lv_page0.setBackgroundResource(R.color.activity_header_bg);
                lv_page1.setBackgroundResource(R.color.activity_header_bg);
        ...
        Fragment mContent = new PurchaseListViewFragment(pageIndex);
